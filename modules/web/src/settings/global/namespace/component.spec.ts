...
import {Controls, NamespaceSettingsComponent} from './component';
...
describe('NamespaceSettingsComponent', () => {
  ...
  // will be fixed in https://github.com/kubernetes/dashboard/pull/8410
  xit('should update setting when namespaces removed after edit()', () => {
    // Given
