...
import {NetworkPolicyListComponent} from './component';
import {MatDialogModule} from '@angular/material/dialog';
import {ChangeDetectorRef, Component, Input} from '@angular/core';
import {NoopAnimationsModule} from '@angular/platform-browser/animations';
import {NetworkPolicy, NetworkPolicyList} from '@api/root.api';
...
describe('NetworkPolicyListComponent', () => {
  let component: NetworkPolicyListComponent;
  let fixture: ComponentFixture<NetworkPolicyListComponent>;
  ...
  const networkPolicyList: NetworkPolicyList = {
    errors: [],
    items: [networkPolicy],
    listMeta: undefined,
  };
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(networkPolicyList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<NetworkPolicyList>, useValue: namespacedResourceServiceStub},
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NetworkPolicyListComponent);
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/networkpolicy/:namespace';
