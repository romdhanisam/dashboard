...
import {RoleBindingListComponent} from './component';
import {MatDialogModule} from '@angular/material/dialog';
import {ChangeDetectorRef, Component, Input} from '@angular/core';
import {NoopAnimationsModule} from '@angular/platform-browser/animations';
import {Metric, RoleBindingList} from '@api/root.api';
...
describe('RoleBindingListComponent', () => {
  let component: RoleBindingListComponent;
  let fixture: ComponentFixture<RoleBindingListComponent>;
  const namespacedResourceServiceStub: any = {
    get: jest.fn(),
  };
  const roleBindingList: RoleBindingList = {
    listMeta: undefined,
    items: [
      {
        objectMeta: {name: 'myRoleBinding'},
        typeMeta: undefined,
      },
    ],
  };
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(roleBindingList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<RoleBindingList>, useValue: namespacedResourceServiceStub},
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RoleBindingListComponent);
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/rolebinding/:namespace';
