...
import {ClusterRoleBindingListComponent} from './component';
import {MatDialogModule} from '@angular/material/dialog';
import {ChangeDetectorRef, Component, Input} from '@angular/core';
import {NoopAnimationsModule} from '@angular/platform-browser/animations';
import {ClusterRoleBindingList} from '@api/root.api';
...
describe('ClusterRoleBindingListComponent', () => {
  let component: ClusterRoleBindingListComponent;
  let fixture: ComponentFixture<ClusterRoleBindingListComponent>;
  const resourceServiceStub: any = {
    get: jest.fn(),
  };
  const clusterRoleBindingList: ClusterRoleBindingList = {
    listMeta: undefined,
    items: [
      {
        objectMeta: {name: 'clusterRoleBinding1'},
        typeMeta: undefined,
      },
    ],
  };
  beforeEach(async () => {
    resourceServiceStub.get.mockReturnValue(of(clusterRoleBindingList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ResourceService<ClusterRoleBindingList>, useValue: resourceServiceStub},
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ClusterRoleBindingListComponent);
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/clusterrolebinding';
