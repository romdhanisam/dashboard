...
describe('CronJobListComponent', () => {
  ...
  const cronJob1: CronJob = {
    ...
    objectMeta: {name: 'cronJob1'},
    typeMeta: undefined,
  };
  const cronJobList: CronJobList = {
    items: [cronJob1],
    cumulativeMetrics: [],
    listMeta: undefined,
  ...
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(cronJobList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<CronJobList>, useValue: namespacedResourceServiceStub},
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/cronjob/:namespace';
