...
import {PersistentVolumeList} from '@api/root.api';
...
describe('PersistentVolumeListComponent', () => {
  ...
  const persistentVolumeList: PersistentVolumeList = {items: [], listMeta: undefined};
  beforeEach(async () => {
    resourceServiceStub.get.mockReturnValue(of(persistentVolumeList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ResourceService<PersistentVolumeList>, useValue: resourceServiceStub},
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/persistentvolume';
