...
import {HorizontalPodAutoscalerListComponent} from './component';
...
describe('HorizontalPodAutoscalerListComponent', () => {
  let component: HorizontalPodAutoscalerListComponent;
  let fixture: ComponentFixture<HorizontalPodAutoscalerListComponent>;
  const namespacedResourceServiceStub: any = {
    get: jest.fn(),
  };
  const horizontalPodAutoscaler1: HorizontalPodAutoscaler = {
    ...
    scaleTargetRef: {
      kind: '',
      name: 'scaleTargetRef1',
    },
    typeMeta: undefined,
  };
  const horizontalPodAutoscalerList: HorizontalPodAutoscalerList = {
    horizontalpodautoscalers: [horizontalPodAutoscaler1],
    listMeta: undefined,
  };
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(horizontalPodAutoscalerList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<HorizontalPodAutoscalerList>, useValue: namespacedResourceServiceStub},
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(HorizontalPodAutoscalerListComponent);
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/horizontalpodautoscaler/:namespace';
