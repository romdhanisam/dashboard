...
import {SecretList} from '@api/root.api';
...
describe('SecretListComponent', () => {
  ...
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(secretList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<SecretList>, useValue: namespacedResourceServiceStub},
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/secret/:namespace';
