...
import {Metric, PodInfo, ReplicaSet, ReplicaSetList} from '@api/root.api';
...
describe('ReplicaSetListComponent', () => {
  let component: ReplicaSetListComponent;
  let fixture: ComponentFixture<ReplicaSetListComponent>;
  ...
  let replicaSet: ReplicaSet = {
    containerImages: [],
    initContainerImages: [],
    objectMeta: {name: 'nginx-aaa'},
    podInfo: undefined,
    typeMeta: undefined,
  };
  const replicaSetList: ReplicaSetList = {
    cumulativeMetrics: [],
    listMeta: undefined,
  ...
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(replicaSetList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<ReplicaSetList>, useValue: namespacedResourceServiceStub},
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ReplicaSetListComponent);
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/replicaset/:namespace';
  ...
  it('hasError should return false', () => {
    // Given
    replicaSet = {...replicaSet, podInfo: {warnings: []} as PodInfo};
    // When
    const hasError: boolean = component.hasErrors(replicaSet);
    // Then
