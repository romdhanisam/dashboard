...
import {Metric, NodeList} from '@api/root.api';
...
describe('NodeListComponent', () => {
  ...
  beforeEach(async () => {
    resourceServiceStub.get.mockReturnValue(of());
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ResourceService<NodeList>, useValue: resourceServiceStub},
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/node';
