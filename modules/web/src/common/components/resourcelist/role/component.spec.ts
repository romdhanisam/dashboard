...
import {Metric, RoleList} from '@api/root.api';
...
describe('RoleListComponent', () => {
  ...
  const roleList: RoleList = {
    ...
    items: [
      {
        objectMeta: {name: 'myRole'},
        typeMeta: undefined,
      },
    ],
  };
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(roleList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<RoleList>, useValue: namespacedResourceServiceStub},
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/role/:namespace';
