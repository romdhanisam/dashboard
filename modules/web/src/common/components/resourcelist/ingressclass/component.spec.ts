...
import {IngressClassListComponent} from './component';
import {MatDialogModule} from '@angular/material/dialog';
import {ChangeDetectorRef, Component, Input} from '@angular/core';
import {NoopAnimationsModule} from '@angular/platform-browser/animations';
import {IngressClassList} from '@api/root.api';
...
describe('IngressClassListComponent', () => {
  let component: IngressClassListComponent;
  let fixture: ComponentFixture<IngressClassListComponent>;
  const resourceServiceStub: any = {get: jest.fn()};
  const ingressClassList1: IngressClassList = {
    items: [{controller: 'controller', objectMeta: undefined, typeMeta: undefined}],
    listMeta: undefined,
  };
  beforeEach(async () => {
    resourceServiceStub.get.mockReturnValue(of(ingressClassList1));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ResourceService<IngressClassList>, useValue: resourceServiceStub},
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(IngressClassListComponent);
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/ingressclass';
