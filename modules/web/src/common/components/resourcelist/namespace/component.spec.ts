...
describe('NamespaceListComponent', () => {
  ...
  const namespaceList: NamespaceList = {listMeta: undefined, namespaces: []};
  beforeEach(async () => {
    resourceServiceStub.get.mockReturnValue(of(namespaceList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ResourceService<NamespaceList>, useValue: resourceServiceStub},
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/namespace';
