...
import {Deployment, DeploymentList, Event, Metric, PodInfo} from '@api/root.api';
...
describe('DeploymentListComponent', () => {
  ...
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(deploymentList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<DeploymentList>, useValue: namespacedResourceServiceStub},
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/deployment/:namespace';
  ...
  it('hasError should return false', () => {
    // Given
    deployment1 = {...deployment1, pods: {warnings: []} as PodInfo};
    // When
    const hasError: boolean = component.hasErrors(deployment1);
    // Then
  ...
  it('hasError should return true', () => {
    // Given
    deployment1 = {...deployment1, pods: {warnings: [{} as Event]} as PodInfo};
    // When
    const hasError: boolean = component.hasErrors(deployment1);
    // Then
