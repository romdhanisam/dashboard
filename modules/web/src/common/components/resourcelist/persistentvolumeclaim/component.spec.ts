...
import {PersistentVolumeClaim, PersistentVolumeClaimList} from '@api/root.api';
...
describe('PersistentVolumeClaimListComponent', () => {
  ...
  const PersistentVolumeClaim1: PersistentVolumeClaim = {
    objectMeta: {name: 'persistentVolumeClaim1'},
    status: '',
    typeMeta: undefined,
    volume: '',
  };
  const persistentVolumeClaimList: PersistentVolumeClaimList = {
    items: [PersistentVolumeClaim1],
    listMeta: undefined,
  };
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(persistentVolumeClaimList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<PersistentVolumeClaimList>, useValue: namespacedResourceServiceStub},
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/persistentvolumeclaim/:namespace';
