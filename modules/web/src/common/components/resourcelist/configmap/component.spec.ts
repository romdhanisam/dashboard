...
import {ConfigMapList} from '@api/root.api';
...
describe('ConfigMapListComponent', () => {
  ...
  const configMapList: ConfigMapList = {
    listMeta: undefined,
    items: [
      {
        objectMeta: {name: 'configMap1'},
        typeMeta: undefined,
      },
    ],
  };
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(configMapList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<ConfigMapList>, useValue: namespacedResourceServiceStub},
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/configmap/:namespace';
