...
describe('EventListComponent', () => {
  ...
  beforeEach(async () => {
    namespacedResourceServiceStub.get.mockReturnValue(of(eventList));
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: NamespacedResourceService<EventList>, useValue: namespacedResourceServiceStub},
  ...
  it('should create endpoint', () => {
    const expectedURI: string = 'api/v1/event/:namespace';
    ...
    expect(httpRequestParams.get('sortBy')).toEqual('d,lastSeen');
  });
});
